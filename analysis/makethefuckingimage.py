...
FILE = "../code/coordinates.npz"
LATEX_COLORLABEL = r"Column\ Density\ [ruh\ oh]"

# format to be plotted:
# 3 arrays:
# lat: galactic lat
# lon: galactic lon
# N: color array (i.e. intensity, velocity)
...
new = make_a_fucking_image(grid, 30.)
im = plt.imshow(new, cmap="gist_earth")
...
thecolorbar.set_label(r"$\mathrm{%s}$" % LATEX_COLORLABEL, fontsize=16, labelpad=20)
